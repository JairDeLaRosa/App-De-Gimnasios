...
export const RegistroUsuarioComun = () => {
  ...
  const handleSubmit=(e)=>{
    if((isValidEmail && isValidName && isValidPassword)===true){
      alert("Formulario enviado correctamente")
    }else{
      e.preventDefault();
      alert("No se pudo enviar formulario")
    }
        ...
        <form className="formulario" onSubmit={handleSubmit}>
          ...
          <div className="contenedor1">
            ...
            <div>
              ...
              />
              {usePassword1 == usePassword2 &&
                usePassword2 != undefined &&
                usePassword2 != "" && (
                  <i className="bi bi-check-lg icons animate__animated animate__bounceIn icon"></i>
                )}
              {usePassword2 != undefined &&
          ...
          <div className="contenedor1">
            ...
            />
            {
              (isValidEmail&& isValidName&&isValidPassword)?<button type="submit" className="btn btn-primary col-3">
              Registrar
            </button>:<button type="submit" className="btn btn-primary col-3">
              siguiente
            </button>
            }
